...
key_file_path="C:\\Users\\yangt\\key\\slack"
myToken = open(key_file_path).read()

# 테스트 메세지
# post_message(myToken,"#stock",'test message')
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A122630', 'A252670', 'A233740', 'A250780', 'A225130',
             'A280940', 'A261220', 'A217770', 'A295000', 'A176950', 'A114800']
             # KODEX 레버리지, KODEX200선물인버스2X, KODEX 코스닥150 레버리지, TIGER 코스닥150선물인버스, KINDEX 골드선물 레버리지(합성 H)
             # KODEX 골드선물인버스, KODEX WTI원유선물, TIGER 원유선물인버스, KODEX 국채선물10년인버스, KODEX 인버스
